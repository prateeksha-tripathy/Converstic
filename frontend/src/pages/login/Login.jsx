    ...
    <div className = 'flex flex-col items-center justify-center min-w-96 mx-auto '>
      <div className='w-full p-6 bg-indigo-200 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-60 border border-gray-100 '>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Link to='/signup' className="link link-hover text-gray-700 hover:text-blue-600 mt-2 inline-block"> Don't have an account?</Link>

          <div>
          <button className="btn width:200 btn-sm mt-2"
            disabled={loading}
          >
